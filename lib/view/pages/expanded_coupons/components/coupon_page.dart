...
class CouponPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final textColor =
        ThemeData.estimateBrightnessForColor(coupon.backgroundColor) ==
                Brightness.dark
            ? cDarkCardTextColor
            : cLightCardTextColor;
        ...
        child: Column(
          children: [
            Container(
              ...
              padding: EdgeInsets.all(cCouponPadding).add(EdgeInsets.only(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      ScrollEffect(
                          ...
                          child: Text(
                            coupon.title,
                            style: cTextStyle.copyWith(fontSize: 14.5),
                          )),
                    ],
                  ),
                  ...
                  ScrollEffect(
                      ...
                      translationFactor: 0,
                      opacityFactor: 0.12,
                      child: Text("Exp " + coupon.expirationDate,
                          style: cTextStyle.copyWith(
            ...
            ClipRRect(
              child: SizedBox(
                height: MediaQuery.of(context).size.height *
                    (1.0 - cCouponTopSizeFactor),
                child: SlideTransition(
                  position: Tween<Offset>(
                    begin: Offset(0.0, -1.0),
                    end: Offset.zero,
                  ).animate(CurvedAnimation(
                      parent: transitionAnimation, curve: Curves.ease)),
                  child: ScrollEffect(
                    index: index,
                    currentPage: currentPage,
                    translationFactor: 0,
